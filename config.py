...
CONFIG = [
    ...
    },
    {
        ...
        'directory': 'Body',
        'required': True,
        'rarity_weights': [311, 89, 244, 7466, 244, 133],
    },
    {
        'id': 3,
        'name': 'Clothes',
        'directory': 'Clothes',
        'required': False,
        'rarity_weights': [100, 56, 56, 89, 188, 188, 188, 188, 142, 188, 188, 188, 188, 142, 142, 188, 188, 188, 188, 56, 142, 188, 124, 142, 188, 188, 188, 188, 188, 124, 124, 56, 142, 188, 188, 188, 188, 74, 124, 124, 124],
    },
    {
        'id': 4,
        'name': 'Head',
    ...
    },
    {
        ...
        'directory': 'Eyes',
        'required': True,
        'rarity_weights': [533, 356, 444, 267, 133, 3333, 889, 178, 356],
    },
    {
        'id': 6,
        'name': 'Mouth',
    ...
    },
    {
        ...
        'required': False,
        'rarity_weights': [1788, 200, 340, 340, 340, 340, 200, 139, 267, 267, 267, 139, 200, 267, 267, 139, 340, 340, 340, 340, 89],
    },
    {
        'id': 10,
